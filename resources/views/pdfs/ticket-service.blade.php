  ...
  <div x-show="show" class="absolute -z-40 font-roboto top-0 left-0 bg-white py-10 !text-[12px] px-4 w-full">
    ...
    <ul class="leading-4">
      <li class="flex justify-end">
        <span>Valor:</span>
        <span class="font-medium w-24 inline-block text-right" x-text="formatToCop(service.subtotal)"></span>
      </li>
    
      <li class="flex justify-end">
        <span>Descuento:</span>
        <span class="font-medium w-24 inline-block text-right" x-text="formatToCop(service.discount)"></span>
      </li>
     
      <li class="flex justify-end">
        <span>Total a pagar:</span>
        <span class="font-medium w-24 inline-block text-right" x-text="formatToCop(service.total)"></span>
      </li>
    </ul>
