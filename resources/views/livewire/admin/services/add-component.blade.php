<div x-data>
    <x-wireui.modal wire:model.defer="openModal" max-width="2xl">
            ...
            <x-wireui.card title="{{!$editId?'Agregar':'Editar' }} componente al servicio">
        ...
        <div class="grid sm:grid-cols-2 gap-4">
            {{-- Componente --}}
            <div class="relative">
                <x-wireui.native-select class="w-full" label="Componente" placeholder="Seleccione un componente"
                    :options="$components" wire:model.defer="form.component_id" optionKeyValue="true" />
        ...
        <x-slot name="footer">
            <div class="text-right space-x-2">
                ...
                @endif
                @if ($editId > 0)
                    <x-wireui.button wire:click="save" text="Actualizar" primary />
                @endif
