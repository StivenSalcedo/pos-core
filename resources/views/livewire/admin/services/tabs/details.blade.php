<div>
    <div class="flex items-center justify-between border-b pb-4 mb-4">
        ...
        <div class="text-right">
            <x-wireui.button primary x-on:click="$wire.emitTo('admin.services.add-component', 'openAddComponent', {{ $service->id }})" text="Agregar componente" icon="add" spinner="update" />
        </div>
    </div>
