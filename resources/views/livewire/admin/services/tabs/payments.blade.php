<div>
  <div class="flex justify-between mb-3">
    ...
    <x-wireui.button sm icon="plus" primary wire:click="addPayment" text="Registrar abono" />
  </div>
  ...
  <table class="min-w-full border text-sm text-gray-700">
    ...
    <tbody>
      ...
      @empty
        <tr><td colspan="5" class="text-center py-4 text-gray-400">No hay pagos registrados</td></tr>
      @endforelse
    </tbody>
  </table>
</div>
