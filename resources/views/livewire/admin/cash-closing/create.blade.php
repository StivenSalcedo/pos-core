<div>
    <x-wireui.modal wire:model.defer="openCreate" max-width="4xl">
        <x-wireui.card title="Cierre de caja" class="!pt-1">

            <x-wireui.errors />

            <div class="grid grid-cols-2 gap-6 mt-4">
                <section>
                    <x-wireui.input type="date" label="Fecha del cierre" wire:model="closing_date"
            ...
            <div class="grid grid-cols-2 gap-6 mt-4">
                ...
                <section>
                    ...
                    <div class="space-y-3">
                        <x-wireui.input label="Base inicial" wire:model.debounce.500ms="base" onlyNumbers />
                        <x-wireui.input label="Dinero real en caja" wire:model.defer="price" onlyNumbers  :disabled="$isFuture"/>
                        <x-wireui.textarea label="Observaciones" wire:model.defer="observations" rows="3" />
                    </div>
                </section>
            </div>
